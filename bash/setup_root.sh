...
apt-get install man-db fzf dnsmasq coercer gcc krb5-user libkrb5-dev libsasl2-modules-gssapi-mit python3-venv pipx pipenv systemd-timesyncd tshark mitm6 chntpw
