...
apt-get install kali-linux-headless man-db fzf dnsmasq coercer gcc bind9-dnsutils krb5-user libkrb5-dev libsasl2-modules-gssapi-mit python3-venv pipx pipenv systemd-timesyncd tshark mitm6 chntpw
